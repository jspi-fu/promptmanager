    ...
    settingsBtn.addEventListener('click', () => {
      ...
      const createField = (label, id, type, placeholder, helpText, defaultValue, showLinkIcon = false) => {
        ...
        if (showLinkIcon) {
          ...
          openRouterLink.addEventListener('mouseenter', () => {
            openRouterLink.style.backgroundColor = dark ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.05)';
            openRouterLink.querySelector('svg').style.stroke = THEME_COLORS.primary;
          });
          ...
          labelWrapper.append(openRouterLink);
        }
        ...
        wrapper.append(labelWrapper, input);
        if (helpText) {
